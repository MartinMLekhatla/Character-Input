...
class MyTestCase(unittest.TestCase):
    ...
    def test_get_user_name(self, _):
        self.assertEqual("Martin", accept_user_name.accept_users_name())

    @patch('builtins.input', return_value='25')
    def test_get_user_age_valid_input_type(self, _):
        self.assertIsInstance(accept_users_age.accept_users_age(), int)

    @patch('builtins.input', return_value='')
    def test_get_user_age_empty_input(self, _):
        self.assertIsNone(accept_users_age.accept_users_age())

    @patch('builtins.input', return_value='25')
    def test_get_user_age_valid_input(self, _):
        self.assertEqual(25, accept_users_age.accept_users_age())
    ...
    def test_calculate_year_turns_100(self):
        ...
        self.assertEqual(expected_year, calculate_year_turns_100.calculate_year_turns_100(current_age))
    ...
    def test_calculate_year_turns_100_near_boundary(self):
        ...
        self.assertEqual(expected_year, calculate_year_turns_100.calculate_year_turns_100(current_age_lower_boundary))
        ...
        self.assertEqual(expected_year, calculate_year_turns_100.calculate_year_turns_100(current_age_upper_boundary))

    def test_calculate_year_turns_100_negative_age(self):
        # Test for a negative age
        current_age = -1
        self.assertIsNone(calculate_year_turns_100.calculate_year_turns_100(current_age))
    ...
    def test_display_turns_100_message_valid_input(self):
        ...
        expected_message = (f'Hello, {name}! You will turn 100 years old in the year {year_hundred} since you are '
                            f'currently {age}.')
        self.assertEqual(display_turns_100_message.display_turns_100_message(name, age, year_hundred), expected_message)
    ...
    @patch('accept_user_name.accept_users_name', return_value='Alice')
    @patch('accept_users_age.accept_users_age', return_value=25)
    @patch('calculate_year_turns_100.calculate_year_turns_100', return_value=2097)
    @patch('display_turns_100_message.display_turns_100_message', return_value="Hello, Alice! You will turn 100 years old in the year 2097 since you are currently 25.")
